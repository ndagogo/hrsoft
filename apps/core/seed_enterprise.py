...
EXTRA_PERMISSIONS = [
    ...
    ("view_training", "View training", "training", "View training courses and enrollments."),
    ("manage_training", "Manage training", "training", "Manage training schedules and enrollments."),
